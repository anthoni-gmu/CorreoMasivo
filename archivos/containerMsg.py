				...
				<table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
					<tr>
						<td align="center" style="padding:40px 0 30px 0;background:#70bbd9;">
							<img src="https://scontent.flim20-1.fna.fbcdn.net/v/t1.6435-9/103686236_998582540560911_3139396867292022443_n.png?_nc_cat=105&ccb=1-3&_nc_sid=973b4a&_nc_ohc=ohFmuh6SNBcAX_dZXCS&_nc_ht=scontent.flim20-1.fna&oh=e642c0593fc36d3fec54db111bc144c2&oe=6122C276" alt="" width="300" style="height:auto;display:block;" />
						</td>
					</tr>
					<tr>
							...
							<table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
								<tr>
									<td style="padding:0 0 36px 0;color:#153643;">
										<h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">"""+nombre+"""</h1>
